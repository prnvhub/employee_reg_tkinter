...
age=Label(text='Age ',font=('bold',10))
age.place(x=400,y=30)
e_age=Entry()
e_age.place(x=500,y=30)

doj=Label(text='D.O.J ',font=('bold',10))
doj.place(x=20,y=70)
e_doj=Entry()
e_doj.place(x=150,y=70)

email=Label(text='Email ',font=('bold',10))
email.place(x=400,y=70)
e_em=Entry()
e_em.place(x=500,y=70)

phone=Label(text='Phone ',font=('bold',10))
...
e_gr=ttk.Combobox(value=genderlist,width=19)
e_gr.place(x=500,y=110)

address=Label(text='Address ',font=('bold',10))
...
Button(text='Submit',command=insert).place(x=320,y=320)
